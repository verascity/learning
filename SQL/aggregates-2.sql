...
SELECT AVG(standard_qty) AS standard_orders, AVG(standard_amt_usd) AS standard_sales, AVG(gloss_qty) AS gloss_orders, AVG(gloss_amt_usd) AS gloss_sales, AVG(poster_qty) AS poster_orders, AVG(poster_amt_usd) AS poster_sales
FROM orders;
