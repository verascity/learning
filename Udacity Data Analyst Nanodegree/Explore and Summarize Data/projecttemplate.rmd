...
wondering if there are ways to tease out the directionality of the relationship.
Is it possible that other characteristics of children or placements modify those
relationships in a revealing way?

```{r echo=FALSE, Multivariate_Plots}
ggplot(aes(x=AgeAtEnd, y=Places))
```
