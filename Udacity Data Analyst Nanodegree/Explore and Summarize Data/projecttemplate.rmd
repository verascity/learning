...
status, and race (in some cases) appear to have an impact on adoption rates. Sex
did not appear to have an impact on adoption rates, however. The number of 
removals and placements appear to be connected to adoption rates in some way, 
but it is difficult to tell what the nature of that connection is.

### Did you observe any interesting relationships between the other features \
(not the main feature(s) of interest)?

I did not analyze other relationships. 
