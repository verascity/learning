...
# names(fosters) <- c("RecNum", "Sex", "ClinDis", "AgeAtEnd", "ChildRace", 
#                     "PrinAgeAtBirth", "PrinFamStr", "TotalRem", "PlacesNumber",
#                     "MannerOfRem", "RemRsnChil", "IsPR", "Adopted", "F1Age",
#                     "F2Age", "FosFamStr", "F1Race", "F2Race", "Transracial")


# names(adoptions) <- c("RecNum", "Sex", "SpecNeeds", "AgeAtAdopt", "ChildRace",
#                       "BioMomAgeAtBirth", "BioMomMarried", "AdoptMomAge",
#                       "AdoptDadAge", "AdoptFamStr", "AdoptMomRace", "AdoptDadRace",
#                       "Transracial")

f_factor_cols <- c("Sex", "ClinDis", "ChildRace", "PrinFamStr", "MannerOfRem",
                   "RemRsnChil", "IsPR", "Adopted", "FosFamStr", "F1Race", 
                   "F2Race", "Transracial")
a_factor_cols <- c("Sex", "SpecNeeds", "ChildRace", "BioMomMarried", "AdoptFamStr",
                   "AdoptMomRace", "AdoptDadRace", "Transracial")
...
ggplot(aes(x=Adopted, y=AgeAtEnd, fill=TotalRem), data=fosters) +
...
ggplot(aes(y=AgeAtEnd, x=Adopted, fill=Adopted), 
       data=subset(fosters, !is.na(ClinDis))) +
  geom_boxplot() +
  facet_wrap(~ClinDis)
...
ggplot(aes(y=AgeAtEnd, x=ChildRace, fill=ChildRace),
       data=subset(fosters, !is.na(ChildRace))) +
  geom_boxplot() +
  facet_grid(Adopted ~ .)
...
adoptees would skew younger than white adoptees). 
